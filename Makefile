...
C_BONUS		= $(addprefix $(BONUS_DIR), $(C_FILES:.c=_bonus.c)) \
				bonus/cone_bonus.c bonus/cone_utils_bonus.c bonus/uvmap_bonus.c bonus/textures_bonus.c \
				bonus/matrix_bonus.c bonus/matrix_helpers_bonus.c bonus/matrix_operations_bonus.c 
O_BONUS		= $(C_FILES:.c=_bonus.o) \
				cone_bonus.o cone_utils_bonus.o uvmap_bonus.o textures_bonus.o \
				matrix_bonus.o matrix_helpers_bonus.o matrix_operations_bonus.o 
